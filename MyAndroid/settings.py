"""
Django settings for MyAndroid project.
...
SECRET_KEY = 'j*^)_!ne7^gy=073rd7ggatuzli7$mo%@1hxjq1@iekg)=1$y#'
...
WSGI_APPLICATION = 'MyAndroid.wsgi.application'
